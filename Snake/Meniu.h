...
namespace Snake {
	...
	private: System::Windows::Forms::Label^  scor;
		...
		void InitializeComponent(void)
		{
			...
			this->Titlu_Meniu->Location = System::Drawing::Point(84, 34);
			...
			this->singleplayer->Font = (gcnew System::Drawing::Font(L"Marker Felt", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->singleplayer->Location = System::Drawing::Point(100, 156);
			this->singleplayer->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->singleplayer->Name = L"singleplayer";
			this->singleplayer->Size = System::Drawing::Size(200, 50);
			...
			this->exit->Font = (gcnew System::Drawing::Font(L"Marker Felt", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->exit->Location = System::Drawing::Point(100, 442);
			this->exit->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->exit->Name = L"exit";
			this->exit->Size = System::Drawing::Size(200, 50);
			...
			this->doubleplayer->Font = (gcnew System::Drawing::Font(L"Marker Felt", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->doubleplayer->Location = System::Drawing::Point(100, 228);
			this->doubleplayer->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->doubleplayer->Name = L"doubleplayer";
			this->doubleplayer->Size = System::Drawing::Size(200, 50);
			...
			this->versuscomputer->Font = (gcnew System::Drawing::Font(L"Marker Felt", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->versuscomputer->Location = System::Drawing::Point(100, 302);
			this->versuscomputer->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->versuscomputer->Name = L"versuscomputer";
			this->versuscomputer->Size = System::Drawing::Size(200, 50);
			...
			this->scor->Font = (gcnew System::Drawing::Font(L"Marker Felt", 14.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->scor->Location = System::Drawing::Point(100, 370);
			this->scor->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->scor->Name = L"scor";
			this->scor->Size = System::Drawing::Size(200, 50);
